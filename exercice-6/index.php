...
<body>
        ...
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">
                    ...
                    Tester sur cette page que tous les paramètres de cette URL existent et les afficher : <strong>index.php?building=12&room=101</strong>
                </p>
            </div>
        </div>
    </div>
    ...
    <main>
        <div>
            <a href="index.php?building=12&room=101">index.php?building=12&room=101</a>
            <?php
            if (isset($_GET['building']) && isset($_GET['room'])) {
                $building = $_GET['building'];
                $room = $_GET['room']; ?>
                <p> <?php echo 'Les paramètres building et room existent' ?> </p>
                <p> <?php var_dump($building) ?> </p>
                <p> <?php var_dump($room) ?> </p>
            <?php } else { ?>
                <p> <?php echo 'Les paramètres building et room n\'existent pas' ?> </p>
            <?php }
            ?>
        </div>
    </main>
