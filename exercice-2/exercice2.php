...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                Tester sur cette page que le paramètre <strong>age</strong> existe et si c'est le cas l'afficher sinon le signaler.
                </p>
    ...
    <main>
        <div>
        <a href="exercice2.php?lastname=Nemare&firstname=Jean">exercice2.php?lastname=Nemare&firstname=Jean</a>
        <?php
            if (isset($_GET['age'])) {
                $age = $_GET['age']; ?>
                <p> <?php echo 'le paramètre age existe' ?> </p>
                <p> <?php var_dump($age) ?> </p>
            <?php } else { ?>
                <p> <?php echo 'le paramètre age n\'existe pas' ?> </p>
            <?php }
            ?>
        </div>
    </main>
