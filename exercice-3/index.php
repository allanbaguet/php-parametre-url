...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                Tester sur cette page que tous les paramètres de cette URL existent  et les afficher : <strong>index.php?startDate=2/05/2016&endDate=27/11/2016</strong>
                </p>
            </div>
        </div>
    </div>
    ...
    <main>
        <div>
            <a href="index.php?startDate=2/05/2016&endDate=27/11/2016">index.php?startDate=2/05/2016&endDate=27/11/2016</a>
            <?php
                if (isset($_GET['startDate']) && isset($_GET['endDate'])) {
                    $startDate = $_GET['startDate'];
                    $endDate = $_GET['endDate']; ?>
                    <p> <?php echo 'Les paramètres startDate et endDate existent' ?> </p>
                    <p> <?php var_dump($startDate) ?> </p>
                    <p> <?php var_dump($endDate) ?> </p>
                <?php } else { ?>
                    <p> <?php echo 'Les paramètres startDate et endDate n\'existent pas' ?> </p>
                <?php } 
                ?>
        </div>
        <!-- filtre de nettoyage -> voir DOC PHP -->
        <!-- <?php 
            // $startDate = filter_imput(INPUT_GET, 'startDate', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
            //         var_dump($startDate);
            ?> -->
    </main>
