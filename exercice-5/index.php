...
<body>
        ...
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">
                    ...
                    Tester sur cette page que tous les paramètres de cette URL existent et les afficher : <strong>index.php?week=12</strong>
                </p>
            </div>
        </div>
    </div>
    ...
    <main>
        <div>
            <a href="index.php?week=12">index.php?week=12</a>
            <?php
            if (isset($_GET['week'])) {
                $week = $_GET['week']; ?>
                <p> <?php echo 'Tout les paramètres existent' ?> </p>
                <p> <?php var_dump($week) ?> </p>
            <?php } else { ?>
